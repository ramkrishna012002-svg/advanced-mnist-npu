# Vivado 2023.2 project creation script
...
puts "Created advanced-mnist-npu Verilog project."
puts "Change PART to match the actual FPGA before synthesis."
